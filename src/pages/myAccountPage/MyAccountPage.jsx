        ...
        <HomeLayout>
            <div className={"bg-secondaryBgColor px-4 sm:px-8"}>
                ...
                <h1 className={"text-3xl font-semibold " +
                    "py-12"}>MY ACCOUNT</h1>
                    <p className={"text-md font-light @mx-3 @leading-6"}>From your account you can view your recent orders, manage
                    ...
                    <div className={""}>
                        ...
                        <button className={"bg-white text-black py-2 px-10 my-24 hover:bg-black hover:text-white cursor-pointer border-[1px] border-transparent hover:border-gray-200 transition-all mt-6"} >EDIT ADDRESS</button>
                    </div>
                </div>
            </div>
        </HomeLayout>
