...
function MyAccountPage() {
    ...
    return (
        <HomeLayout>
                ...
                <section className={"bg-secondaryBgColor px-8"}>
                    <div className={"container mx-auto max-w-screen-lg text-white"}>
                        <AccountLayout>
                        {/*<h1 className={"text-3xl font-semibold " +*/}
                        {/*    "py-12"}>MY ACCOUNT</h1>*/}

                        <p className={"text-xl font-light mx-3 pt-12 leading-6"}>From your account you can view your recent
                            orders, manage
                        ...
                        <div className={"flex flex-col gap-" +
                            ...
                            <button
                                className={"bg-white text-black p-2 my-24 hover:bg-black hover:text-white cursor-pointer border-[1px] border-transparent hover:border-gray-200 transition-all mt-6 w-1/4"}>EDIT
                                ADDRESS
                            </button>
                        </div>
                        </AccountLayout>
