            ...
            <AnimatePresence>
                {
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className={`${user?.roles?.includes(ROLE_ADMIN) || true ? "right-0":"translate-x-[50%] sm:translate-x-[0] right-1/2 sm:right-0"} absolute bg-white top-[100%] shadow-lg inline-block min-w-[200px] z-[9999] rounded overflow-hidden `}>
